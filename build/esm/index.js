...
var require_assertion = __commonJS({
  "node_modules/chai/lib/chai/assertion.js"(exports, module) {
    var config2 = require_config();
    module.exports = function(_chai, util5) {
...
var require_expect = __commonJS({
  "node_modules/chai/lib/chai/interface/expect.js"(exports, module) {
    module.exports = function(chai3, util5) {
...
${snapshots.join("\n\n")}
`;
  const skipWriting = fs.existsSync(snapshotPath) && await ((_a2 = fs) == null ? void 0 : _a2.promises.readFile(snapshotPath, "utf8")) === content;
  if (skipWriting)
    return;
...
function formatTitle(template, items, idx) {
  ...
  let formatted = util$12.format(template, ...items.slice(0, count));
  if (isObject(items[0])) {
...
function withGlobal(_global) {
  ...
  const utilPromisify = _global.process && util4.promisify;
