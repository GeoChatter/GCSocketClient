 ...
 */
    async #logInToMap() {
        const streamerSettings: StreamerSettings = await this.connection.invoke("MapLogin", this.streamerCode)
 ...
 */
   ...
   */
    ...
    */
    async sendGuess(guess: Guess, checkGuess = true): Promise<void> {
 ...
 */
    async sendFlag(data: Flag) {
        await this.connection.invoke("SendFlagToClients", data)
    }
