...
describe("init", () => {
    describe("starting GCSignalRClient", () => {
        ...
        const client = new GCSocketClient(
            "https://dev.geochatter.tv/guess/geoChatterHub",
            "code",
            {
                onStreamerSettings,
                onGameStart,
        ...
        it("map login should trigger streamer settings", () => {
            ...
            expect(onGameStart).toBeCalled();
            expect(onRoundStart).toBeCalled();
        });
        ...
        describe("gameStart", () => {
            it("should give me the app options", () => {
                ...
                expect(onGameStart).toHaveBeenCalledWith(
                    connectionBuilder.mapGameSettings
                );
            });
        });
        ...
        describe("roundStart", () => {
            it("should give me the round info", () => {
                ...
                expect(onRoundStart).toHaveBeenCalledWith(
                    connectionBuilder.mapRoundSettings
                );
            });
        });
        describe("roundEnd", () => {
            it("should give me the round info", () => {
                ...
                expect(onRoundEnd).toHaveBeenCalledWith(
                    connectionBuilder.mapRoundResult
                );
            });
        });
        describe("gameEnd", () => {
            it("should give me the round info", () => {
                ...
                expect(onGameEnd).toHaveBeenCalledWith(
                    connectionBuilder.mapGameEndResult
                );
            });
        });
        describe("gameExit", () => {
